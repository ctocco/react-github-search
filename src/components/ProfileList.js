                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-4">
                            <ul className="list-group list-group-flush">
                                ...
                                <li className="list-group-item remove"><i className="fas fa-compress-arrows-alt text-info"></i>{" "}Followers: {" "}{profile.followers}</li>
                                <li className="list-group-item remove"><i className="fas fa-expand-arrows-alt text-info"></i>{" "}Following: {' '}{profile.following}</li>
                                <li className="list-group-item remove">Public Repos: {' '}{profile["public_repos"]}</li>
                                <li className="list-group-item remove">Blog: {" "}{profile.blog ? profile.blog : "-"}</li>
                                <li className="list-group-item remove">{profile.email ? profile.email : "-"}</li>
                            </ul>
                        </div>
                        <div className="container col-sm-4 pr-5">
                            ...
                            <div className="d-flex flex-column-reverse align-items-end justify-content-between button">
                                <button className="btn btn-info btn-md mt-2" href="#" role="button" id={profile.id} onClick={this.handleClick}>Remove User</button>
